...
If you want to do Stripe testing follow the [hcb server dev docs](https://github.com/hackclub/hcb/blob/main/dev-docs/stripe_testing.md) then add the Stripe env details.

## Building on iOS

1. Install Xcode & Node.js 24
2. `npm install`
...
1. Install Android Studio & Node.js 24
...
Note: Android Push Provisioning will not work without the private-sdk submodule
