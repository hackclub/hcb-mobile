...
export class CanonicalTransactionPolicy extends OrgScopedPolicy<Transaction> {
  ...
  setCustomMemo(): boolean { return this.adminOrTeamMember; }

  setCategory(): boolean { return this.isAdmin; }

  export(): boolean { return this.adminOrTeamMember; }

  waiveFee(): boolean { return this.isAdmin; }
  unwaiveFee(): boolean { return this.isAdmin; }
  markBankFee(): boolean { return this.isAdmin; }
